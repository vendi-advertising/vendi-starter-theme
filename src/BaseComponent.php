...
abstract class BaseComponent extends VendiComponent implements JsonSerializable
{
    ...
    public function _vendi_get_background_settings_handle_layouts(bool $renderErrorMessagesForMissingValues, ComponentStyles $style, ?WP_Post $post_id = null): void
    {
...
//            $this->_vendi_get_background_settings_handle_layout_background_video( $renderErrorMessagesForMissingValues, $style, $post_id );
    ...
    private function vendi_get_background_settings(ComponentStyles $previousStyles, bool $renderErrorMessagesForMissingValues = true, $key = 'backgrounds', $postId = false): void
    {
    ...
    protected function renderComponentSpecificCssBlock(): void
    {
        ...
        $this->vendi_get_background_settings($this->componentStyles, key: $this->getFieldKeyForBackgrounds(), postId: $this->getPostIdForBackgrounds());
        ...
        if ( ! $defaultStyles && ! $visibleOnlyStyles) {
            return;
        }
    ...
    protected function performAdditionalActionsOnBackgroundImage(array $background_image): void {}
    ...
    private function _vendi_get_background_settings_handle_layout_background_image(bool $renderErrorMessagesForMissingValues, ComponentStyles $style, ?WP_Post $post_id = null): void
    {
        ...
        $this->performAdditionalActionsOnBackgroundImage($background_image);
