...
<?php
vendi_render_headline('intro_heading', additional_css_classes: ['header', 'padding-inline-small']); ?>
<?php
if ($additional_copy = $component->getSubField('additional_copy')): ?>
    <div class="copy padding-inline-small">
        <?php
        esc_html_e($additional_copy); ?>
    </div>
<?php
endif; ?>
<?php
vendi_load_modern_component('accordion/accordion-controls', object_state: ['accordion_items' => $component->getAccordionItems()]); ?>
    <div
        class="accordion-items"
        data-columns-count="<?php
        echo esc_attr($component->getNumberOfColumns()); ?>"
    >
        <?php
